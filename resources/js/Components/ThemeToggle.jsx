 ...
 * Affiche une icône soleil (☀️) en mode sombre pour passer au clair,
 * et une icône lune (🌙) en mode clair pour revenir au sombre.
 */
    ...
    return (
        <button
            ...
            className={`flex h-9 w-9 items-center justify-center rounded-lg border transition-colors duration-200
                ${isDark
                    ? 'border-soil-700 bg-soil-900/60 text-yolk-400 hover:border-yolk-500 hover:bg-soil-800'
